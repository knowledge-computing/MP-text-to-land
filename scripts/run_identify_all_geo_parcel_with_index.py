...
def parse_args():
    ...
    parser.add_argument('--output_path', type=str, default="./output/all_geo_parcel_w_txt_n_image_ids_n_index.jsonl",
                        help='Save model recognition results associated with its indices to this path as jsonl file')
